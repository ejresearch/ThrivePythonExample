...
interface PMRSectionProps {
  onSelectType: (type: QuestionnaireType) => void;
}

export function PMRSection({ onSelectType }: PMRSectionProps) {
  const assessment = {
    type: 'pmr-4-followup' as const,
    title: '4 Questions + Follow-up',
    description: 'Comprehensive PMR assessment with follow-up questions',
  };
  ...
  return (
    <div className="p-8 bg-white rounded-2xl shadow-lg">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Intro to PMR</h2>
      ...
      <div className="flex justify-center">
        <button
          ...
          className="bg-white rounded-xl border-2 border-gray-100 p-6 hover:border-teal-500 transition-all duration-300 transform hover:-translate-y-1 text-center w-full max-w-md"
        >
